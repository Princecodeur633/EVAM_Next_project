...
const CATALOG_BY_ROLE: Record<Profil, CatalogKey[]> = {
  ...
  AGENT_PRODUCTION: ["articles", "ofList", "etapes", "pertes", "stock", "lots"],
  RESPONSABLE_QUALITE: ["articles", "lots", "controles", "stock", "fichesTechniques", "ofList"],
  MAGASINIER: [
    "articles",
    "depots",
    "stock",
  ...
  CAISSIER: ["articles", "commandes", "factures", "caisses", "sessionsCaisse", "encaissements", "ecartsCaisse", "clients"],
